      ...
      >
        ...
        <div className='mb-4'>
          ...
          <textarea
            ...
            className='border rounded w-full py-2 px-3'
            rows='4'
            placeholder='Adicione uma descrição para o seu imóvel'
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-2'>
            ...
            <div>
              <input
                ...
                onChange={handleAmenitiesChange}
              />
              <label htmlFor='amenity_washer_dryer'>Máquina de lavar e Secadora</label>
            </div>
            <div>
              <input
                type='checkbox'
            ...
            <div>
              <input
                ...
                onChange={handleAmenitiesChange}
              />
              <label htmlFor='amenity_hot_tub'>Banheira de hidromassagem</label>
            </div>
            <div>
              <input
                type='checkbox'
                ...
                onChange={handleAmenitiesChange}
              />
              <label htmlFor='amenity_24_7_security'>24/7 Segurança</label>
            </div>
            <div>
              <input
                type='checkbox'
            ...
            <div>
              <input
                ...
                onChange={handleAmenitiesChange}
              />
              <label htmlFor='amenity_dishwasher'>Lava Louça</label>
            </div>
            <div>
              <input
                type='checkbox'
            ...
            <div>
              <input
                ...
                onChange={handleAmenitiesChange}
              />
              <label htmlFor='amenity_balcony_patio'>Varanda</label>
            </div>
            <div>
              <input
                type='checkbox'
            ...
            <div>
              <input
                ...
                onChange={handleAmenitiesChange}
              />
              <label htmlFor='amenity_coffee_maker'>Cafeteria</label>
            </div>
          </div>
        </div>
        ...
        <div className='mb-4 bg-blue-50 p-4'>
          <label className='block text-gray-700 font-bold mb-2'>
            Avaliações (Deixe em branco se não aplicar)
          </label>
        ...
        <div className='mb-4'>
          <label
            ...
            className='block text-gray-700 font-bold mb-2'
          >
            Imagens (Selecione no mínimo 4 imagens)
          </label>
          <input
            type='file'
            id='images'
